...
[![Ask DeepWiki](https://devin.ai/assets/askdeepwiki.png)](https://deepwiki.com/Ming3210/PPEC_API)
...
3. **Run the application:**
   Use the Gradle wrapper to build and start the Spring Boot application.
   ```sh
   ./gradlew bootRun
   ```
